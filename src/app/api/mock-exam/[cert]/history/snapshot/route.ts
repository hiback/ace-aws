...
import { getAccountBackedMockExamHistorySnapshot } from '@/server/mock-exam-sync/service'
...
export async function GET(_request: Request, context: RouteContext) {
  ...
  return json(await getAccountBackedMockExamHistorySnapshot(userId, cert))
}
