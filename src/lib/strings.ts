export const STRINGS = {
  zh: {
    ...
    accountSyncComingSoon: '同步功能即将上线',
    accountSyncComingSoonDescription: '当前阶段只启用登录和账号本地进度，尚未上传到服务器。',
    signOut: '退出登录',
  ...
  en: {
    ...
    accountSyncComingSoon: 'Sync coming soon',
    accountSyncComingSoonDescription:
      'This stage enables login and account-local progress only. Progress is not uploaded yet.',
    signOut: 'Sign out',
    signOutClearsProgress: 'Signing out clears the current account-local progress mirror.',
    loginWelcome: 'Welcome back',
    loginSubtitle: 'Sync progress across all devices after signing in',
    loginOr: 'or',
